...
export const ColourForm: React.FC<ColourFormProps> = ({ initialData }) => {
    ...
    const title = initialData ? "Edit Colour" : "Add Colour";
    const description = initialData ? "Edit a colour" : "Add new colour";
    const toastMessage = initialData ? "Colour updated" : "Colour added";
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error("Ensure all related categories are removed.")
        } finally {
            setLoading(false);
            setOpen(false);
        }
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <div className="flex items-center gap-x-4">
                                    <Input disabled={loading} placeholder="Hex value" {...field}/>
